				...
				case 0:
					...
					if(errn == 0) {
						if(eventCode == 0) {
							...
							/* [Alex] */
							// printf("[C] appHandAppProtocolTYPE->ProtocolNamespace.characters = %ls\n", appHandAppProtocolType->ProtocolNamespace.characters);
							// printf("[C] appHandAppProtocolTYPE->ProtocolNamespace.charactersLen = %d\n", appHandAppProtocolType->ProtocolNamespace.charactersLen);
							
							errn = decodeUnsignedInteger16(stream, &appHandAppProtocolType->ProtocolNamespace.charactersLen);

							// printf("[C] appHandAppProtocolTYPE->ProtocolNamespace.characters = %ls\n", appHandAppProtocolType->ProtocolNamespace.characters);
							// printf("[C] appHandAppProtocolTYPE->ProtocolNamespace.charactersLen = %d\n", appHandAppProtocolType->ProtocolNamespace.charactersLen);
							// printf("[C] appHandAppProtocolTYPE->ProtocolNamespace.VersionNumberMajor = %d\n", appHandAppProtocolType->VersionNumberMajor);
							// printf("[C] appHandAppProtocolTYPE->ProtocolNamespace.VersionNumberMinor = %d\n", appHandAppProtocolType->VersionNumberMinor);
							// printf("[C] appHandAppProtocolTYPE->ProtocolNamespace.SchemaID = %d\n", appHandAppProtocolType->SchemaID);
							// printf("[C] appHandAppProtocolTYPE->ProtocolNamespace.Priority = %d\n", appHandAppProtocolType->Priority);

							// printf("[C] sizeof appHandAppProtocolTYPE->ProtocolNamespace = %ld\n", sizeof(appHandAppProtocolType->ProtocolNamespace));
							// printf("[C] offsetof(appHandAppProtocolType, ProtocolNamespace.characters) = %ld\n", offsetof(struct appHandAppProtocolType, ProtocolNamespace.characters));
							// printf("[C] offsetof(appHandAppProtocolType, ProtocolNamespace.charactersLen) = %ld\n", offsetof(struct appHandAppProtocolType, ProtocolNamespace.charactersLen));
							// printf("[C] offsetof(appHandAppProtocolType, VersionNumberMajor) = %ld\n", offsetof(struct appHandAppProtocolType, VersionNumberMajor));
							// printf("[C] offsetof(appHandAppProtocolType, VersionNumberMinor) = %ld\n", offsetof(struct appHandAppProtocolType, VersionNumberMinor));
							// printf("[C] offsetof(appHandAppProtocolType, SchemaID) = %ld\n", offsetof(struct appHandAppProtocolType, SchemaID));
							// printf("[C] offsetof(appHandAppProtocolType, Priority) = %ld\n", offsetof(struct appHandAppProtocolType, Priority));
	...
	while(!done) {
		...
		case 7:
			...
			if (errn == 0) {
				switch(eventCode) {
				case 0:
				// printf("[C][init_appHandAnonType_supportedAppProtocolReq] appHandAnonType_supportedAppProtocolReq->AppProtocol.arrayLen = %d\n", appHandAnonType_supportedAppProtocolReq->AppProtocol.arrayLen);
...
int decode_appHandExiDocument(bitstream_t* stream, struct appHandEXIDocument* exiDoc) {
	...
	if(errn == 0) {
		...
		// printf("[C][decode_appHandExiDocument] errn = %d\n", errn);
		// printf("[C][decode_appHandExiDocument] eventCode = %d\n", eventCode);
