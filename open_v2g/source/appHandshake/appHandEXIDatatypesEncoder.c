...
int encode_appHandExiDocument(bitstream_t* stream, struct appHandEXIDocument* exiDoc) {
	...
	if(errn == 0) {
		// printf("[C] exiDoc->supportedAppProtocolReq_isUsed = %d\n", exiDoc->supportedAppProtocolReq_isUsed);
		// printf("[C] exiDoc->supportedAppProtocolRes_isUsed = %d\n", exiDoc->supportedAppProtocolRes_isUsed);
		// printf("[C] exiDoc->supportedAppProtocolReq.AppProtocol.arrayLen = %d\n", exiDoc->supportedAppProtocolReq.AppProtocol.arrayLen);
		
		// printf("[C] exiDoc.supportedAppProtocolReq.AppProtocol.array[0].ProtocolNamespace.charactersLen = %d\n", exiDoc->supportedAppProtocolReq.AppProtocol.array[0].ProtocolNamespace.charactersLen);
        // printf("[C] exiDoc.supportedAppProtocolReq.AppProtocol.array[0].SchemaID = %d\n", exiDoc->supportedAppProtocolReq.AppProtocol.array[0].SchemaID);
        // printf("[C] exiDoc.supportedAppProtocolReq.AppProtocol.array[0].VersionNumberMajor = %d\n", exiDoc->supportedAppProtocolReq.AppProtocol.array[0].VersionNumberMajor);
        // printf("[C] exiDoc.supportedAppProtocolReq.AppProtocol.array[0].VersionNumberMinor = %d\n", exiDoc->supportedAppProtocolReq.AppProtocol.array[0].VersionNumberMinor);
        // printf("[C] exiDoc.supportedAppProtocolReq.AppProtocol.array[0].Priority = %d\n", exiDoc->supportedAppProtocolReq.AppProtocol.array[0].Priority);
		...
		if ( exiDoc->supportedAppProtocolReq_isUsed == 1u ) { 
			// printf("[C] exiDoc->supportedAppProtocolReq_isUsed == 1u\n");
			
			/* START_ELEMENT({urn:iso:15118:2:2010:AppProtocol}supportedAppProtocolReq) */
			errn = encodeNBitUnsignedInteger(stream, 2, 0);
			// printf("[C] encodeNBitUnsignedInteger Errn = %d\n", errn);
			...
			// printf("#2 exiDoc->supportedAppProtocolRes_isUsed == 1u");
